...
public class GymDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EquipmentCategory>().HasData(
            new EquipmentCategory { Id = categoryId1, Name = "Máy Cardio", Description = "Các loại máy chạy bộ, xe đạp, trượt tuyết", AvgMaintenanceCost = 200000m, CreatedAt = new DateTime(2024, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        );
